...
<section id="join-form" title="Registration Form">
    <section id="main-join-us-form">
        ...
        <div class="fix-width-he-cont-us-main">
            ...
            <form onsubmit="return confirm('Do you really want to submit the form?');"  method="POST"  id="join-form-main">
                ...
                data-key="rzp_live_Q9SUNBdqM3a6k6"
                data-amount="20000"
                data-currency="INR"
                data-id="JOIN-US"
    ...
    <section id="send-query" title="Contact us">
        <section id="main-form-contact-us">
            ...
            <div class="fix-width-he-cont-us-main">
                ...
                <form  method="POST" id="get-in-touct-main">
                    ...
                    <input type="submit" value="Send message" title="Sumbit your query" name="send-me-message-sumbit-class" id="send-me-message-sumbit-class">
...
if(isset($_POST['join-name'] )&& isset($_POST['join-mobile'] ) && isset($_POST['join-mail']) && isset($_POST['join-shop-name']) && isset($_POST['join-how-help'])&& isset($_POST['join-address'] ) && isset($_POST['join-message']) && isset($_POST['join-reffer']))
{
    ...
    try {
        ...
        $mail->addAddress($city, $name);     //Add a recipient
        ...
        $mail->Body    = "<div style='background-color: #ffb300; display: inherit; justify-content: center; padding: 3em;'>
        <div>
            Dear $name <br>Thank you for joining us!! <br><br>
            <center><h1>Your Details</h1></center><br>
        </div>
    <center>
        <div>
            <table style='min-width: 80%; max-width: 80%; margin-left: 10%;'>
                <tr>
                    <td>Name : </td>
                    <td>$name</td>
                </tr>
    ...
    <div>
        For more details please <a href='tel:+906350029208'>Contact us</a> Or <a href='tel:+906350029208'>Call us +91 635-0029-208</a><br><br>
        <center>*Copyright 2022 trusteepartner.tech . All rights reserved.</center>
    </div>
...
try {
    ...
    //Recipients
    $mail->setFrom('trusteepartner.autoreply@gmail.com', 'TRUSTEE PARTNER');
    $mail->addAddress('trusteepartner.autoreply@gmail.com', 'Contact us - get in touch');     //Add a recipient
    


    //Content
    $mail->isHTML(true);                                  //Set email format to HTML
    $mail->Subject = 'contact us - get in touch';
    $mail->Body    = "Name : $conname <br> Mobile Number : $conmobile <br> Subject : $consubject <br> Messagae : $conmessage ";
